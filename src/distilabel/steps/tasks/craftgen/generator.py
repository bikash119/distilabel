...
class CRAFTGenerator(Task):
    ...
    The `CRAFTGenerator` is inspired by the CRAFT, which was designed to generate
    task-specific synthetic dataset generation through Corpus Retrieval and Augmentation.
